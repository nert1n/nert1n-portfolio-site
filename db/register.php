...
// Проверка существования адреса электронной почты и имени в базе данных
$sql = "SELECT * FROM `user` WHERE login = '$login'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "Имя уже зарегистрировано.";
    exit();
}
...
if ($conn->query($sql) === TRUE) {
    ...
    try {
        ...
        $mail->setFrom('reg@perchikrp.com.ua', 'Підтверження електронної пошти на сайті');  // Замените на свои данные
